...
All agents exist in environments that provide context to their agency. An agent receives information about the \textbf{environment} it find itself in (i.e. \textbf{percepts}) through \textbf{sensors} and acts on the environment through \textbf{actuators}. Both actuators and sensors are usually among the defining components of the agent. Another defining component of an agent would be setup of its internal decision-making mechanism.
