...
import optuna
import numpy as np
from evaluation_utils_module import select_minimal_examples, rename, task_job, load_from_grid_search, load_from_optuna, load_from_relevant_file2
...
def make_final_examination(en, alg, container, name, seeds, source="optuna"):
    ...
    most_promising, most_promising_index = select_minimal_examples([t.params for t in new_study.best_trials])
    """
    if source == "optuna":
        ...
        most_promising = load_from_relevant_file2(en=en, alg=alg, container=container, filename="relevant_finals.json")
