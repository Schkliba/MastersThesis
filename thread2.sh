...
# wait
python adaptive_gridsearch.py -e lunarlander -a lambda -c fit_archiving -o $OUTPUT -r bash_run -H 3
python adaptive_gridsearch.py -e lunarlander -a diff -c fit_archiving -o $OUTPUT -r bash_run -H 3